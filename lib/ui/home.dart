...
ListView createListView() {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            subtitle: Row(
              ...
              Text(" | Rp. "+this.penjualanList[index].jumlah, style: 
  ...
  void updateListView(){
    ...
    Future<List<Penjualan>> penjualanListFuture=dbHelper.getPenjualanList(); penjualanListFuture.then((penjualanList){
      setState(() {
